...
| M11-R009 | 🔵 Agent-ready | Replace repeated broad line motifs with smaller component-scaled stone/wood/moss clusters that vary by seed while preserving restraint and the shared seam. | Source, phone, thumbnail, and isolate surfaces show authored organic richness without lowering any V11 dimension below `3/5`. | Focused renderer/material tests, regenerated evidence/package receipts, technical preflight, reference-boundary, and control-drift checks. |
