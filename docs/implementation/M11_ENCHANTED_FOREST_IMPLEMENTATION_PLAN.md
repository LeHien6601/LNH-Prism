...
| M11-R007 | 🔵 Agent-ready | Reduce Enchanted Forest face-material scale/opacity, confine moss growth to edge anchors, and rebalance treatment around content hierarchy while retaining distinct material channels. | Source, phone, thumbnail, and isolate surfaces retain independently legible stone/wood/moss/root materials while ornament restraint and portrait composition meet their `3/5` minima. | Focused renderer/material tests, regenerated evidence/package receipts, technical preflight, reference-boundary, and control-drift checks. |
