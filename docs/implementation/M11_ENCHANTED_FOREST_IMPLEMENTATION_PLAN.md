...
| M11-R010 / V11 re-review | 🟣 Human decision | Apply the approved V11 rubric to the regenerated R009 evidence and record the review outcome. | All required source, target-phone, thumbnail, matrix, and technical hard-gate surfaces are inspected; a pass/fail decision and any bounded remediation are recorded. | Authorized review under `AGENTS.md` with the existing V11 rubric and evidence package. |
