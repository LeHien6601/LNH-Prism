...
3. **Preview and transparent output (next):** deterministic PNG, alpha/effect-padding
   validation, richer comparison surfaces, state sheets, slicing previews, and
   mobile-readability evidence.
4. **Audit and approval hardening:** cross-job shared registries and drift
...
yet ready for approval, promotion, or delivery. The next milestone must add
transparent PNG output and richer visual/mobile evidence.
