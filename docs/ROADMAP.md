...
**Implementation sequence:** 🟢 R-020 defined the [ordered M11 implementation/evidence plan](implementation/M11_ENCHANTED_FOREST_IMPLEMENTATION_PLAN.md). 🔵 R-018 / M11-A1 is next: generalize review-reference production-boundary validation and register Enchanted Forest before any renderer or material work. M11-A2 binds contracts/materials, M11-A3 renders the matrix/evidence, M11-A4 packages/preflights, and M11-A5 is the V11 human review.
